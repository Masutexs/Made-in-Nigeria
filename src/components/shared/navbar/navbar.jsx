...
function Navbar() {
  return (
    <div>
      <nav className=" bg-black  justify-center flex items-center gap-10 py-4">
        ...
        <div className="w-[423px] h-8 bg-white rounded-lg relative">
          <input className="w-[423px] h-8 bg-white rounded-lg placeholder:text-center" type="text" name="" id="search" placeholder='search' />
          <svg xmlns="http://www.w3.org/2000/svg" className='absolute top-2' width="16" height="15" viewBox="0 0 16 15" fill="none" >
        ...
        {/* account */}
        <div className="w-[109px] h-[31px] px-2 py-[7px] bg-white rounded-[9px] justify-start items-center flex">          
          ...
          <select className="w-[109px]  text-black h-[31px] px-2 py-[7px] bg-white rounded-[9px] justify-start items-center gap-1 inline-flex" name="" id="Account">
        ...
        <div className=' h-[31px] px-2 py-[7px] text-black rounded-[9px] items-center flex bg-white' >
        <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19" fill="none">
          ...
          <select className=" h-[31px]  py-[7px]  flex-col justify-start items-start gap-2 inline-flex" name="" id="Help" placeholder="Help">
            <option>Help</option>
          </select>
  ...
  <path d="M4.84973 3.33333H22L19.6667 11.5H6.10616M20.8333 16.1667H6.83333L4.5 1H1M8 20.8333C8 21.4777 7.47766 22 6.83333 22C6.18901 22 5.66667 21.4777 5.66667 20.8333C5.66667 20.189 6.18901 19.6667 6.83333 19.6667C7.47766 19.6667 8 20.189 8 20.8333ZM20.8333 20.8333C20.8333 21.4777 20.311 22 19.6667 22C19.0223 22 18.5 21.4777 18.5 20.8333C18.5 20.189 19.0223 19.6667 19.6667 19.6667C20.311 19.6667 20.8333 20.189 20.8333 20.8333Z" stroke="#1E1E1E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
     <button className="text-stone-900 text-sm font-normal font-['Poppins']">Cart</button>
